...
namespace EsoCPU.Instructions.Basic;
...
public class SET : IDefinition
{
    ...
    public List<ParameterConstraint> ParameterConstraints => new() { ParameterConstraint.Memory, ParameterConstraint.ConstantOrMemory };
...
public class JEZ : IDefinition
{
    ...
    public List<ParameterConstraint> ParameterConstraints => new() { ParameterConstraint.ConstantOrMemory, ParameterConstraint.Constant };
